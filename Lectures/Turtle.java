...
public class Turtle{
    ...
    //Instance varaible have unique values to each object (instance of the class)
    ...
    //Defaut constructor: no argument constructor
    public Turtle (){
        x = y = 0.0;
        angle = 90.0;
    ...
    //turnLeft by updating the turtle dangle
    public void turnLeft (double delta){
        angle += delta;
    }

    //moves the turtle forward by stepSize
    //dra a line from the old x, y to the new x, y
    ...
    //equals methos to compare this object with another one
    ...
    public boolean equal (Object other){
        ...
        if (other instanceof Turtle) {
            ...
            return this.x == o.x && this.y == o.y && this.angle == o.angle && this.color.equals(o.color); //cannot compare colors like this: this.color == o.color (bc this would compare two references)
